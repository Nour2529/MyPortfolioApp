...
class CustomNavigationBar extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final items = {
      ...
      kHomeMyEducationsTag:localization.educations,
      kHomeMyExperiencesTag: localization.experiences,
      kHomeMyProjectsTag: localization.projects,
    ...
    List<Widget> buildItems() {
      return [
        for (String key in items.keys)
          Expanded(
            child: NavigationItem(  //sna3neha wahdna , taaml creation bouton menu
              text: items[key]!,
