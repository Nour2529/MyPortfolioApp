        ...
        children: [
          Row(
            children: [
              Expanded(
                child: LanguageSkill(
                  name: localization.languageNameArab,
                  icon: SvgPicture.asset(
                    kArabFlagRoundedSvgPath,
                  ),
                ),
              ),
          ...
          Row(
            children: [
              Expanded(
                child: LanguageSkill(
                  name: localization.languageNameFrench,
                  icon: SvgPicture.asset(
                    kFrenchFlagRoundedSvgPath,
                  ),
                ),
              ),
              const SizedBox(width: 20),
              Expanded(
                child: LanguageSkill(
                  name: localization.languageNameGermany,
                  icon: SvgPicture.asset(
                    kGermanyFlagRoundedSvgPath,
                  ),
                ),
              ),
            ],
